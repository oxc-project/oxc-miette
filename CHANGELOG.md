...
- Correctly calculate emoji sequences width ([#85](https://github.com/oxc-project/oxc-miette/pull/85))
...
- *(deps)* Lock file maintenance ([#80](https://github.com/oxc-project/oxc-miette/pull/80))
- *(deps)* Update github-actions ([#82](https://github.com/oxc-project/oxc-miette/pull/82))
- *(deps)* Lock file maintenance rust crates ([#83](https://github.com/oxc-project/oxc-miette/pull/83))
- *(deps)* Lock file maintenance rust crates ([#84](https://github.com/oxc-project/oxc-miette/pull/84))
...
- Organize renderer and source modules ([#315](https://github.com/oxc-project/oxc-miette/pull/315))
## [4.0.0] - 2026-08-09
...
- Restore chunked underline rendering ([#283](https://github.com/oxc-project/oxc-miette/pull/283))
- Reduce snippet rendering allocations ([#284](https://github.com/oxc-project/oxc-miette/pull/284))
- Stream fitting diagnostic titles ([#285](https://github.com/oxc-project/oxc-miette/pull/285))
- Stream blank line-number gutters ([#286](https://github.com/oxc-project/oxc-miette/pull/286))
- Stream numbered line gutters ([#287](https://github.com/oxc-project/oxc-miette/pull/287))
- Stream fitting help text ([#288](https://github.com/oxc-project/oxc-miette/pull/288))
...
- Remove narratable report handler ([#300](https://github.com/oxc-project/oxc-miette/pull/300))
- Separate diagnostic protocol from application errors ([#301](https://github.com/oxc-project/oxc-miette/pull/301))
- Prune unused diagnostic features ([#302](https://github.com/oxc-project/oxc-miette/pull/302))
- Simplify source span protocol ([#303](https://github.com/oxc-project/oxc-miette/pull/303))
- Narrow diagnostic protocol ([#304](https://github.com/oxc-project/oxc-miette/pull/304))
- *(reporting)* Remove unused rendering state ([#305](https://github.com/oxc-project/oxc-miette/pull/305))
- *(protocol)* Require contiguous source data ([#306](https://github.com/oxc-project/oxc-miette/pull/306))
- *(protocol)* Remove unused implementations ([#307](https://github.com/oxc-project/oxc-miette/pull/307))
...
- *(deps)* Update rust crates ([#290](https://github.com/oxc-project/oxc-miette/pull/290))
- *(deps)* Update semgrep/semgrep docker tag to v1.171.0 ([#291](https://github.com/oxc-project/oxc-miette/pull/291))
- *(deps)* Update rust crate trybuild to v1.0.119 ([#296](https://github.com/oxc-project/oxc-miette/pull/296))
- *(deps)* Update github actions ([#297](https://github.com/oxc-project/oxc-miette/pull/297))
- *(deps)* Update codspeedhq/action action to v5 ([#298](https://github.com/oxc-project/oxc-miette/pull/298))
- *(deps)* Update codspeedhq/action action to v5.0.2 ([#310](https://github.com/oxc-project/oxc-miette/pull/310))
- *(deps)* Update rust crate ureq to v3.4.0 ([#311](https://github.com/oxc-project/oxc-miette/pull/311))
...
- Measure cold first-render cost separately ([#292](https://github.com/oxc-project/oxc-miette/pull/292))
## [3.0.1] - 2026-07-19
...
- Forward SourceCode::name through Arc and Cow ([#162](https://github.com/oxc-project/oxc-miette/pull/162))
...
- *(deps)* Update rust crates ([#139](https://github.com/oxc-project/oxc-miette/pull/139))
- *(deps)* Update github-actions ([#140](https://github.com/oxc-project/oxc-miette/pull/140))
- *(deps)* Update github-actions ([#142](https://github.com/oxc-project/oxc-miette/pull/142))
- *(deps)* Update rust crates ([#143](https://github.com/oxc-project/oxc-miette/pull/143))
- *(deps)* Update dependency rust to v1.93.1 ([#144](https://github.com/oxc-project/oxc-miette/pull/144))
- *(deps)* Update github-actions ([#145](https://github.com/oxc-project/oxc-miette/pull/145))
- *(deps)* Update rust crates ([#146](https://github.com/oxc-project/oxc-miette/pull/146))
- *(deps)* Update rust crate syn to v2.0.116 ([#147](https://github.com/oxc-project/oxc-miette/pull/147))
- *(deps)* Update github-actions ([#148](https://github.com/oxc-project/oxc-miette/pull/148))
- *(deps)* Update rust crate syn to v2.0.117 ([#149](https://github.com/oxc-project/oxc-miette/pull/149))
- *(deps)* Update rust crate owo-colors to v4.3.0 ([#150](https://github.com/oxc-project/oxc-miette/pull/150))
- *(deps)* Update github-actions ([#151](https://github.com/oxc-project/oxc-miette/pull/151))
- *(deps)* Update dependency rust to v1.94.0 ([#152](https://github.com/oxc-project/oxc-miette/pull/152))
- *(deps)* Update github-actions ([#153](https://github.com/oxc-project/oxc-miette/pull/153))
- *(deps)* Update rust crate quote to v1.0.45 ([#154](https://github.com/oxc-project/oxc-miette/pull/154))
- *(deps)* Update taiki-e/install-action action to v2.68.25 ([#155](https://github.com/oxc-project/oxc-miette/pull/155))
- *(deps)* Update github-actions ([#156](https://github.com/oxc-project/oxc-miette/pull/156))
- Apply cargo shear --fix ([#157](https://github.com/oxc-project/oxc-miette/pull/157))
- *(deps)* Update github-actions ([#158](https://github.com/oxc-project/oxc-miette/pull/158))
- *(deps)* Update dependency rust to v1.94.1 ([#159](https://github.com/oxc-project/oxc-miette/pull/159))
- *(deps)* Update github-actions ([#160](https://github.com/oxc-project/oxc-miette/pull/160))
- *(deps)* Update rust crates ([#161](https://github.com/oxc-project/oxc-miette/pull/161))
## [2.7.0] - 2026-01-04
